...
public class ElasticSearchExtension extends LifecycleAdapter {
    ...
    public ElasticSearchExtension(GraphDatabaseService gds, String hostName, String indexSpec, String indexAll, Boolean discovery, Boolean includeIDField, Boolean includeLabelsField) {
        Map iSpec;
        try {
